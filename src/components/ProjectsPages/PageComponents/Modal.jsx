...
export default function Modal({ clickedImg, handleRotationRight, handleRotationLeft, setClickedImg }) {
  ...
  return (
    <div className='overlayContainer dismiss' id='modal' onClick={handleClick}>
